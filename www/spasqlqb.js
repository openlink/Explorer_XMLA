...
function Connection() 
{
  var callback = location.protocol+ "//"+location.host + location.pathname 
        + location.search;

  if (g_sid == null) {
    window.location = location.protocol+ "//"+location.host 
        + "/DAV/VAD/val/authenticate.vsp?reslabel=SPASQL%20Query%20Builder&realm=urn%3Avirtuoso%3Aval%3Arealms%3Adefault&sidParamName=sid&res="
        +callback;
    return;
  }
